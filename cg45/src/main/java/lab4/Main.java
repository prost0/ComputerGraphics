...
//Variant 20 (Right circular hollow cylinder)
package lab4;
...
public class Main extends Application{
    ...
    private void initial() {
        ...
        win = glfwCreateWindow(800, 800, "Лабораторная работа №4,5", 0, 0);
    ...
    private void loop() {
        ...
        Figure figure = new Figure(15, 100);
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("Лабораторная работа №4,5 Вариант 12, Якимович Александр");
